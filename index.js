...
//let price=[50000,55000,60000,57000,62000,60000]//Second Case
 ...
 //let price=[65000,68000,67500,70000,90000];
...
// console.log(min_term.indexOf(Math.min(min_term)));
    ...
    // console.log(mean,mean_down,mean_up);
    console.log("Least Square Regression Results")
    console.log(mean)
         console.log(mean_up)
...
function dell_data_out(mean,mean_up,mean_down){
 ...
 console.log("Dell Price after Comparison");
     console.log(final_price_1);
        console.log(final_price_2);
         console.log(final_price_3);
    ...
    db.query("select Series from dell4",function (error,results,fields) {
        ...
        console.log("Dell Models");
        console.log("1."+Series_1);
        console.log("2."+Series_2);
        console.log("3."+Series_3);
